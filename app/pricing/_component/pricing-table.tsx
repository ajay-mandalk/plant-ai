            ...
            <div className="bg-white dark:bg-zinc-900 border-[1.5px] border-black dark:border-white rounded-xl p-10 relative shadow-sm">
              <div className="mb-10">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100 tracking-[-0.01em]">agrofly Pro</h3>
                  <Badge
                    variant="secondary"
              ...
              {isCurrentPlan(STARTER_TIER) ? (
                ...
                >
                  {isAuthenticated === false ? 'Sign in to upgrade' : 'Upgrade to agrofly Pro'}
