...
const AgroflyLogoHeader = () => (
  <div className="flex items-center gap-2 mb-2">
    <Image
      ...
      quality={100}
    />
    <h2 className="text-xl font-normal font-be-vietnam-pro text-neutral-800 dark:text-neutral-200">agrofly</h2>
  </div>
);
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      const sharePromise = async () => {
                        ...
                        const shareUrl = `https://agrofly.ai/search/${chatId}`;
