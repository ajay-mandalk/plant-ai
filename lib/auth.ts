...
// Add validation before auth initialization
...
const polarClient = new Polar({
    ...
    ...(process.env.POLAR_ACCESS_TOKEN ? {} : { server: 'sandbox' }),
});
...
export const auth = betterAuth({
    ...
    socialProviders: {
        ...
        twitter: {
            clientId: serverEnv.TWITTER_CLIENT_ID as string,
            clientSecret: serverEnv.TWITTER_CLIENT_SECRET as string,
        },
    },
    plugins: [
        polar({
    ...
    trustedOrigins: ["https://localhost:3000", "https://agrofly.ai", "https://www.agrofly.ai"],
    allowedOrigins: ["https://localhost:3000", "https://agrofly.ai", "https://www.agrofly.ai"],
});